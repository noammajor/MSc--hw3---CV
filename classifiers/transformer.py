...
class CaptioningTransformer(nn.Module):
    ...
    def forward(self, features, captions):
        ...
        caption_emm = self.positional_encoding(self.embedding(captions))
        image_projections = self.visual_projection(features).unsqueeze(1)
        caption_emm = caption_emm
        image_projections = image_projections
        out = self.transformer(caption_emm, image_projections, tgt_mask)
